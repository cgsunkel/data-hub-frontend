...
export const COLLECTION_LISTS = {
  INVESTMENTS__PROJECTS: {
    INVESTMENTS__PROJECTS_LOADED: 'INVESTMENTS__PROJECTS_LOADED',
    INVESTMENTS__PROJECTS_SELECT_PAGE: 'INVESTMENTS__PROJECTS_SELECT_PAGE',
  ...
  INVESTMENTS__PROFILES: {
    INVESTMENTS__PROFILES_LOADED: 'INVESTMENTS__PROFILES_LOADED',
    INVESTMENTS__PROFILE_SELECT_PAGE: 'INVESTMENTS__PROFILE_SELECT_PAGE',
  },
}
